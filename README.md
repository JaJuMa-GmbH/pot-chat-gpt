# :speech_balloon: Chat GPT Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/)

<img align="right" width="35%" height="auto" src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/JaJuMa-Chat-GPT-Power-Toy-For-Magento-2-small.png">  

ChatGPT Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/en) is a quick action toy 
that allows using ChatGPT from Magento backend.
...
* ChatGPT chats from Magento backend
...
<td>
    <table>
     <tr>
        <td><b>ChatGPT Toy</b><br>Dark Mode</td>
        <td><b>ChatGPT Toy</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Chat-GPT-Power-Toy-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Chat-GPT-Power-Toy-Light.jpg"></td>
    </tr>
     <tr>
        <td><b>Chat Popup</b><br>Dark Mode</td>
        <td><b>Chat Popup</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Chat-GPT-Power-Toy-Popup-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Chat-GPT-Power-Toy-Popup-Light.jpg"></td>
    </tr>
    </table>
</td>
...
```
composer require jajuma/pot-chat-gpt
```
...
and enable & configure ChatGPT Toy.

To get a Chat GPT API Key, please register for OpenAI here:  
https://platform.openai.com/  
and create your API Key here:  
https://platform.openai.com/api-keys  

Please find valid API endpoints here:  
https://platform.openai.com/docs/guides/text-generation

Please find available models here:  
https://platform.openai.com/docs/models/overview

After configure and enabling, see the floating button at left/right edge of your screen 
in your Backend and Frontend (while logged in as Admin).  
When click on this button, the Power Toys Panel will open 
displaying the ChatGPT Toy.
A click on ChatGPT Toy will open the ChatGPT chat popup - Happy Chatting!

* [See Manual for more details](https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/manuals/JaJuMa_Chat_GPT_Power_Toy_Manual_v001.pdf)


## License

The code is licensed under the [MIT License (MIT)](https://github.com/JaJuMa/pot-chat-gpt/blob/master/LICENSE)
